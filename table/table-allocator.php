...
// {
//     echo "Started deallocation<br>";
//     global $con;
//     $queryForGettingTableForDeallocation = "SELECT cv.visit_id FROM customer_visit cv LEFT JOIN table_allocated ta ON cv.visit_id = ta.visit_id WHERE table_allocation_time <= DATE_SUB(NOW(), INTERVAL 10 MINUTE) AND have_seated = 0 AND visit_finished = 0";
...
//                 if (mysqli_query($con, $queryUpdateStatusToFinished) !== false) {
